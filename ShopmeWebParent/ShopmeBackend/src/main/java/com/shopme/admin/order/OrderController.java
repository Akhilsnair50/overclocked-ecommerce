...
import com.shopme.admin.security.OverclockedUserDetails;
...
public class OrderController {
    ...
    public String listByPage(
            ...
            @AuthenticationPrincipal OverclockedUserDetails loggedUser) {
    ...
    public String viewOrderDetails(@PathVariable("id") Integer id, Model model,
        ...
        } catch ( com.shopme.common.exception.OrderNotFoundException ex) {
    ...
    public String editOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra,
        ...
        try {
            ...
            model.addAttribute("tracks",order.getOrderTracks());
//            model.addAttribute("status",order.getOrderTracks());
