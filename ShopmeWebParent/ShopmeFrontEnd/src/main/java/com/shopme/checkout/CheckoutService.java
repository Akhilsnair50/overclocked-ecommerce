...
public class CheckoutService {
    ...
    public CheckoutInfo prepareCheckout(List<CartItem> cartItems, ShippingRate shippingRate) {
        ...
        float razorPayTotal = calculateTotalForRazorpay(cartItems);
        ...
        checkoutInfo.setRazorPayTotal(razorPayTotal);
    ...
    private Integer calculateTotalForRazorpay(List<CartItem> cartItems){
        Integer total = 0;

        for (CartItem item : cartItems) {
            total += item.getRazorpaySubTotal();
        }
