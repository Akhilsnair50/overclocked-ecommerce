...
public class CheckoutInfo {
    ...
    public float getRazorPayTotal() {
        return razorPayTotal;
    }

    public void setRazorPayTotal(float razorPayTotal) {
        this.razorPayTotal = razorPayTotal;
    }
